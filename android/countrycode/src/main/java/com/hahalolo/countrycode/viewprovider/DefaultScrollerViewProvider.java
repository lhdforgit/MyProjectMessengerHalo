package com.hahalolo.countrycode.viewprovider;
...
import com.hahalolo.countrycode.R;
import com.hahalolo.countrycode.Utils;
...
public class DefaultScrollerViewProvider extends ScrollerViewProvider {
    ...
    public View provideHandleView(ViewGroup container) {
        ...
        InsetDrawable handleBg = new InsetDrawable(ContextCompat.getDrawable(getContext(), R.drawable.fastscroll_default_handle), horizontalInset, verticalInset, horizontalInset, verticalInset);
