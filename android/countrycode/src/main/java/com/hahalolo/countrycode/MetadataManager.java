...
import com.hahalolo.countrycode.Phonemetadata.PhoneMetadataCollection;
...
final class MetadataManager {
  static final String MULTI_FILE_PHONE_NUMBER_METADATA_FILE_PREFIX =
      "/io/hahalolo/libphonenumber/android/data/PhoneNumberMetadataProto";
  static final String ALTERNATE_FORMATS_FILE_PREFIX =
      "/io/hahalolo/libphonenumber/android/data/PhoneNumberAlternateFormatsProto";
  static final String SHORT_NUMBER_METADATA_FILE_PREFIX =
      "/io/hahalolo/libphonenumber/android/data/ShortNumberMetadataProto";
