...
package com.halo.widget.jsoup.select;

import com.halo.widget.jsoup.helper.Validate;
import com.halo.widget.jsoup.nodes.Comment;
import com.halo.widget.jsoup.nodes.Document;
import com.halo.widget.jsoup.nodes.DocumentType;
import com.halo.widget.jsoup.nodes.Element;
import com.halo.widget.jsoup.nodes.Node;
import com.halo.widget.jsoup.nodes.PseudoTextElement;
import com.halo.widget.jsoup.nodes.TextNode;
import com.halo.widget.jsoup.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static com.halo.widget.jsoup.internal.Normalizer.lowerCase;
import static com.halo.widget.jsoup.internal.Normalizer.normalize;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.halo.widget.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (com.halo.widget.jsoup.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    com.halo.widget.jsoup.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
