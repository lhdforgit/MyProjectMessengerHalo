...
import com.hahalolo.messenger.databinding.ChatReplayOutcomingItemBinding

class ChatReplayOutComingItem(binding: ChatReplayOutcomingItemBinding,
                              chatListener: ChatListener,
                              holderListener: HolderListener,
                              imageLoader: ImageLoader,
                              style: MessagesListStyle
)
    : ChatOutComingItem<ChatReplayOutcomingItemBinding>(binding, chatListener, holderListener, imageLoader, style) {
    ...
    companion object {
        fun create(parent: ViewGroup,
                   chatListener: ChatListener,
                   holderListener: HolderListener,
                   imageLoader: ImageLoader, style: MessagesListStyle): ChatReplayOutComingItem {
            val binding = DataBindingUtil.inflate<ChatReplayOutcomingItemBinding>(LayoutInflater.from(parent.context),
                    R.layout.chat_replay_outcoming_item,
                    parent,
                    false)
            return ChatReplayOutComingItem(binding, chatListener, holderListener, imageLoader, style)
        }
    }

    override fun initView(binding: ChatReplayOutcomingItemBinding) {
