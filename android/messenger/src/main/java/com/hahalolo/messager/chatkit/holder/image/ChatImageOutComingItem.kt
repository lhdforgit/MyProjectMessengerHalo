...
class ChatImageOutComingItem(
    binding: ChatImageOutcomingItemBinding,
    chatListener: ChatListener,
    holderListener: HolderListener,
    imageLoader: ImageLoader,
    style: MessagesListStyle
) : ChatOutComingItem<ChatImageOutcomingItemBinding>(
    binding,
    chatListener,
    holderListener,
    imageLoader,
    ...
    companion object {
        fun create(
            ...
            imageLoader: ImageLoader,
            style: MessagesListStyle
        ): ChatImageOutComingItem {
            val binding = DataBindingUtil.inflate<ChatImageOutcomingItemBinding>(
                LayoutInflater.from(parent.context),
                R.layout.chat_image_outcoming_item,
                parent,
                false
            )
            return ChatImageOutComingItem(
                binding!!,
                chatListener,
                holderListener,
                imageLoader,
    ...
    override fun initView(binding: ChatImageOutcomingItemBinding) {
