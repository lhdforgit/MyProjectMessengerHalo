...
import com.hahalolo.messenger.databinding.ConversationDetailMediaItemBinding
import com.halo.common.utils.ThumbImageUtils

class ConversationDetailMediaHolder private constructor(
    private val binding: ConversationDetailMediaItemBinding,
    ...
    private fun loadImage(path: String) {
        ...
        requestManager.load(uri).into(binding.photoIv)
    }
    ...
    companion object {
        fun getHolder(
            ...
            widthScreen: Int
        ): ConversationDetailMediaHolder {
            val inflater = LayoutInflater.from(parent.context)
            val binding = DataBindingUtil.inflate<ConversationDetailMediaItemBinding>(
                inflater,
                R.layout.conversation_detail_media_item,
                parent, false
            )
            return ConversationDetailMediaHolder(
                binding,
                requestManager,
                listener,
                widthScreen
