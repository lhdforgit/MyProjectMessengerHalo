...
import com.hahalolo.messenger.databinding.ChatImagesOutcomingItemBinding

class ChatMutilImageOutComingItem(
    binding: ChatImagesOutcomingItemBinding,
    chatListener: ChatListener,
    holderListener: HolderListener,
    imageLoader: ImageLoader,
    style: MessagesListStyle
) : ChatOutComingItem<ChatImagesOutcomingItemBinding>(
    binding,
    chatListener,
    holderListener,
    imageLoader,
    ...
    companion object {
        ...
        ): ChatMutilImageOutComingItem {
            val binding = DataBindingUtil.inflate<ChatImagesOutcomingItemBinding>(
                LayoutInflater.from(parent.context),
                R.layout.chat_images_outcoming_item,
                parent,
                false
            )
            return ChatMutilImageOutComingItem(
                binding,
                chatListener,
                holderListener,
                imageLoader,
    ...
    override fun initView(binding: ChatImagesOutcomingItemBinding) {
