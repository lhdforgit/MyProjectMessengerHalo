...
package com.hahalolo.qrcode.barcodedetection
...
import com.hahalolo.qrcode.InputInfo
import com.hahalolo.qrcode.PreferenceUtils
import com.hahalolo.qrcode.QRCodeReaderViewModel
import com.hahalolo.qrcode.camera.CameraReticleAnimator
import com.hahalolo.qrcode.camera.FrameProcessorBase
import com.hahalolo.qrcode.camera.GraphicOverlay
...
class BarcodeProcessor(
    ...
    private val workflowModel: QRCodeReaderViewModel
    ...
    override fun onSuccess(
        ...
        if (barcodeInCenter == null) {
            ...
            workflowModel.setWorkflowState(QRCodeReaderViewModel.WorkflowState.DETECTING)
        } else {
            ...
            if (sizeProgress < 1) {
                ...
                workflowModel.setWorkflowState(QRCodeReaderViewModel.WorkflowState.CONFIRMING)
            } else {
                ...
                if (PreferenceUtils.shouldDelayLoadingBarcodeResult(graphicOverlay.context)) {
                    ...
                    workflowModel.setWorkflowState(QRCodeReaderViewModel.WorkflowState.SEARCHING)
                } else {
                    workflowModel.setWorkflowState(QRCodeReaderViewModel.WorkflowState.DETECTED)
        ...
        return ValueAnimator.ofFloat(0f, endProgress).apply {
            ...
            addUpdateListener {
                if ((animatedValue as Float).compareTo(endProgress) >= 0) {
                    graphicOverlay.clear()
                    workflowModel.setWorkflowState(QRCodeReaderViewModel.WorkflowState.SEARCHED)
