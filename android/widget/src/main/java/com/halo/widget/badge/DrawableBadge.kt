...
class DrawableBadge private constructor(
    ...
    class Builder(private val context: Context) {
        ...
        fun textColor(@ColorRes textColorRes: Int) =
            apply { this.textColor = ContextCompat.getColor(context, textColorRes) }

        fun badgeColor(@ColorRes badgeColorRes: Int) =
            apply { this.badgeColor = ContextCompat.getColor(context, badgeColorRes) }

        fun badgeBorderColor(@ColorRes badgeBorderColorRes: Int) =
            apply { this.badgeBorderColor = ContextCompat.getColor(context, badgeBorderColorRes) }
        ...
        fun badgeBorderSize(@Px badgeBorderSize: Float) =
            apply { this.badgeBorderSize = badgeBorderSize }
        ...
        fun build(): DrawableBadge {
            ...
            if (textColor == null) textColor(R.color.text_on_primary)
            if (badgeColor == null) badgeColor(R.color.badges)
            if (badgeBorderColor == null) badgeBorderColor(R.color.badges)
