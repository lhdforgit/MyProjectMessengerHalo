...
public class ReadMoreTextView extends TextView {
    ...
    public ReadMoreTextView(Context context, AttributeSet attrs) {
        ...
        int resourceIdTrimCollapsedText =
                typedArray.getResourceId(R.styleable.ReadMoreTextView_trimCollapsedText, R.string.text_view_read_more);
        int resourceIdTrimExpandedText =
                typedArray.getResourceId(R.styleable.ReadMoreTextView_trimExpandedText, R.string.text_view_read_hide);
