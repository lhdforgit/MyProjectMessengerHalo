 ...
 */
public class ShapeGroupView extends FrameLayout {
    ...
    public ShapeGroupView(Context context) {
        super(context);
        initView();
    }

    public ShapeGroupView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initAttributeSet(attrs);
        initView();
    }

    public ShapeGroupView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawShadow(Bitmap offscreenBitmap, Canvas canvas) {
        if (canvas != null && offscreenBitmap != null) {
            ...
            canvasBm.drawBitmap(offscreenBitmap, null,
                    new Rect(shadowWidth, shadowWidth,
            ...
            canvas.drawBitmap(offscreenBitmap, null,
                    new Rect(boderWidth, boderWidth,
