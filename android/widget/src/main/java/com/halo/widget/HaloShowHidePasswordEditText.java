...
/**
 * @author ngannd
 * Create by ngannd on 10/07/2019
 * <p>
 * Custom version of EditText that shows and hides password onClick of the visibility icon
 */
public class HaloShowHidePasswordEditText extends HaloEditText {
    ...
    public HaloShowHidePasswordEditText(Context context) {
        super(context);
        init(null);
    }

    public HaloShowHidePasswordEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public HaloShowHidePasswordEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            visibilityIndicatorShow = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_show, R.drawable.ic_password_show);
            visibilityIndicatorHide = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_hide, R.drawable.ic_password_hidden);
            ...
            visibilityIndicatorShow = R.drawable.ic_password_show;
            visibilityIndicatorHide = R.drawable.ic_password_hidden;
