...
//import com.halo.widget.bottomdrawer.utils.BottomDrawerDelegateV2
//import java.util.concurrent.atomic.AtomicBoolean
//import java.util.concurrent.atomic.AtomicInteger
//@Deprecated("Thay thế bằng V3")
//class BottomDrawerDialogV2(
//    context: Context?,
//    @StyleRes theme: Int = R.style.BottomDialogTheme
//) :
//    AppCompatDialog(context, theme), BottomDialog {
//
//    val bottomDrawerDelegate = BottomDrawerDelegateV2(this.context, this)
//
//    val drawer: BottomDrawerV2
//        get() = bottomDrawerDelegate.drawer
//
//    val behavior: BottomSheetBehavior<BottomDrawerV2>?
...
//        }
//
//        fun build() = BottomDrawerDialogV2(context, theme).apply {
//
