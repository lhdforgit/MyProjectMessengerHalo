...
class ItemView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray) {
        ...
        barInactiveColor = styles.getColor(R.styleable.OtpTextView_bar_inactive_color, ResourcesCompat.getColor(context.resources, R.color.app_background_divider, null))
        barErrorColor = styles.getColor(R.styleable.OtpTextView_bar_error_color, ResourcesCompat.getColor(context.resources, R.color.text_notice, null))
        ...
        if (otpTextTypeFace != null) {
            ...
            val tf = ResourcesCompat.getFont(context, R.font.muli)
            textView?.typeface = tf
        }
