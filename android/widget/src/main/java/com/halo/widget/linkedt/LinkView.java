 ...
 * Out of the box, there are {@link LinkTextView}, {@link LinkEditText}, and {@code SocialAutoCompleteTextView}.
 * It can also be implemented in any {@link android.view.View}
 * using {@link LinkViewHelper}.
 */
public interface LinkView {
    ...
    interface OnClickListener {
         ...
         */
        void onClick(@NonNull LinkView view, @NonNull CharSequence text);
    }
    ...
    interface OnChangedListener {
         ...
         */
        void onChanged(@NonNull LinkView view, @NonNull CharSequence text);
    }
}