 ...
 * @see LinkView
 */
public class LinkAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView implements LinkView {
    private final LinkViewHelper helper;
    ...
    public LinkAutoCompleteTextView(Context context) {
        this(context, null);
    }

    public LinkAutoCompleteTextView(Context context, AttributeSet attrs) {
        this(context, attrs, androidx.appcompat.R.attr.autoCompleteTextViewStyle);
    }

    public LinkAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        helper = new LinkViewHelper(this, attrs);
     ...
     */
    @Override
    public void setOnHashtagClickListener(@Nullable LinkView.OnClickListener listener) {
     ...
     */
    @Override
    public void setOnMentionClickListener(@Nullable LinkView.OnClickListener listener) {
     ...
     */
    @Override
    public void setOnHyperlinkClickListener(@Nullable LinkView.OnClickListener listener) {
