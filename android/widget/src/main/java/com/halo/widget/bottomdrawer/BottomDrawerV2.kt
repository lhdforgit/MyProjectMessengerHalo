...
//@Deprecated("Thay thế bằng V3")
//class BottomDrawerV2 @JvmOverloads constructor(
//    context: Context,
//    attrs: AttributeSet? = null,
//    def: Int = 0,
//    defStyleAttr: Int = 0
//) : FrameLayout(context, attrs, def, defStyleAttr) {
//
...
//        fullHeight = context.resources.displayMetrics.heightPixels
//        collapseHeight = fullHeight / 2
...
//    }
//
//    fun globalTranslationViews() {
//        val distance = fullHeight - collapseHeight
//        if (isEnoughToFullExpand && top < distance) {
...
//            heightPixels =
//                context.resources.displayMetrics.heightPixels.stringLog("0000 heightPixels")
...
//
////            fullHeight = height.stringLog("0000 height")
////            collapseHeight = heightPixels.stringLog("0000 heightPixels")
//
