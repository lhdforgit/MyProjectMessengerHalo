...
/**
 * Default adapter for displaying hashtag in {@link LinkAutoCompleteTextView}.
 ...
 */
public class HashtagArrayAdapter<T extends Hashtagable> extends LinkArrayAdapter<T> {
