package com.hahalolo.progress.mask
...
import com.hahalolo.progress.util.NUMBER_ONE
import com.hahalolo.progress.util.NUMBER_ZERO
import com.hahalolo.progress.util.WRAPPING_LIMIT
import com.hahalolo.progress.util.background
import com.hahalolo.progress.util.isZero
import com.hahalolo.progress.util.spannable
import kotlin.math.absoluteValue

internal class ProgressMask(
    val view: View,
    ...
    private val paint: Paint by lazy { Paint().apply { color = this@ProgressMask.color } }
