 ...
 * Created by ndn
 * Created on 7/12/18
 * Check status when user click MediaView
 */
public class CheckView extends View {
    ...
    private static final int SIZE = 56; // dp
    ...
    private void init(Context context) {
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.ic_check, context.getTheme());
    }
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            int defaultColor = ResourcesCompat.getColor(
                    getResources(), R.color.app_background,
                    getContext().getTheme());
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
