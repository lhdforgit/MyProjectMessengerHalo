...
import com.halo.okdownload.BuildConfig;
...
import com.halo.okdownload.core.breakpoint.BreakpointStoreOnCache;
import com.halo.okdownload.core.breakpoint.DownloadStore;
import com.halo.okdownload.core.connection.DownloadConnection;
import com.halo.okdownload.core.connection.DownloadUrlConnection;
...
public class Util {
    ...
    DownloadStore createDefaultDatabase(Context context) {
        // You can import through com.halo.okdownload:sqlite:{version}
        final String storeOnSqliteClassName
                = "com.halo.okdownload.core.breakpoint.BreakpointStoreOnSQLite";
    ...
    DownloadConnection.Factory createDefaultConnectionFactory() {
        final String okhttpConnectionClassName
                = "com.halo.okdownload.core.connection.DownloadOkHttp3Connection$Factory";
        try {
