...
public class AttachmentStreamUriLoader implements ModelLoader<AttachmentStreamUriLoader.AttachmentModel, InputStream> {
  ...
  @Override
  public @Nullable
  LoadData<InputStream> buildLoadData(@NonNull AttachmentModel attachmentModel, int width, int height, @NonNull Options options) {
  ...
  public static class Factory implements ModelLoaderFactory<AttachmentModel, InputStream> {
    ...
    @Override
    public @NonNull
    ModelLoader<AttachmentModel, InputStream> build(@NonNull MultiModelLoaderFactory multiFactory) {
