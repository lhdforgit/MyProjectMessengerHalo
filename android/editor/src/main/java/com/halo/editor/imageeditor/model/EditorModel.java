...
import com.halo.editor.imageeditor.UndoRedoStackListener;
...
public final class EditorModel implements Parcelable, RendererContext.Ready {
  ...
  public static EditorModel createForCoverEditing() {
    EditorModel editorModel = new EditorModel(false, EditorElementHierarchy.create());
    editorModel.setCropAspectLock(true);
    return editorModel;
  }
