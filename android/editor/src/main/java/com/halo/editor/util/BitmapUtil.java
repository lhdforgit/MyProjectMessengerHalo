...
public class BitmapUtil {
    ...
    private static <T> ScaleResult createScaledBytes(@NonNull Context context,
        ...
        try {
            ...
            Timber.i(String.format(Locale.US, "Initial scaled bitmap has size of %d bytes.", scaledBitmap.getByteCount()));
            Timber.i(String.format(Locale.US, "Max dimensions %d x %d, %d bytes", maxImageWidth, maxImageHeight, maxImageSize));
