...
import com.halo.editor.imageeditor.renderers.CropAreaRenderer;
import com.halo.editor.imageeditor.renderers.InverseFillRenderer;
import com.halo.editor.imageeditor.renderers.OvalGuideRenderer;
...
final class EditorElementHierarchy {
  ...
  private static @NonNull EditorElement createRoot(boolean circleEdit) {
    ...
    if (circleEdit) {
      EditorElement circle = new EditorElement(new OvalGuideRenderer(R.color.divider));
