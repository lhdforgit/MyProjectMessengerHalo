...
public class ContactPhotoLoader implements ModelLoader<ContactPhoto, InputStream> {
  ...
  @Override
  public @Nullable
  LoadData<InputStream> buildLoadData(@NonNull ContactPhoto contactPhoto, int width, int height, @NonNull Options options) {
  ...
  public static class Factory implements ModelLoaderFactory<ContactPhoto, InputStream> {
    ...
    @Override
    public @NonNull
    ModelLoader<ContactPhoto, InputStream> build(@NonNull MultiModelLoaderFactory multiFactory) {
