...
@ActivityScoped
public class CoverSelectionActivity extends DaggerSplitActivity
  ...
  public static final String EXTRA_MEDIA = "cover.media";
  ...
  public static Intent getIntentForCameraCapture(@NonNull Context context) {
    return new Intent(context, CoverSelectionActivity.class);
  }
    ...
    if (media.getUri() != null) {
      getSupportFragmentManager().beginTransaction()
              .replace(R.id.fragment_container,
                      ImageEditorFragment.newInstanceForCover(media.getUri()), IMAGE_EDITOR)
  ...
  private void handleSave() {
    ...
    MediaRepository.transformMedia(this,
            ...
            Collections.singletonMap(currentMedia, new ImageEditorModelRenderMediaTransform(model, null)),
            output -> {
