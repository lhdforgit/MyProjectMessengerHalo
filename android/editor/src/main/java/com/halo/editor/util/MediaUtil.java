...
import com.halo.editor.slide.GifSlide;
import com.halo.editor.slide.ImageSlide;
import com.halo.editor.slide.Slide;
import com.halo.editor.slide.VideoSlide;
import com.halo.editor.slide.ViewOnceSlide;
...
public class MediaUtil {
    ...
    public static boolean hasVideoThumbnail(Uri uri) {
        ...
        if (URLUtil.isNetworkUrl(uri.toString()) && uri.toString().contains("hahalolo.com")) {
            return true;
        }
    ...
    @WorkerThread
    public static @Nullable
    Bitmap getVideoThumbnail(Context context, Uri uri, long timeUs) {
        if ("com.android.providers.media.documents".equals(uri.getAuthority())) {
