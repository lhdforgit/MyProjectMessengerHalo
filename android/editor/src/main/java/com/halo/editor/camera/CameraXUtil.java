...
import com.halo.editor.util.BitmapDecodingException;
import com.halo.editor.util.BitmapUtil;
...
public class CameraXUtil {
  ...
  private static final String TAG = CameraXUtil.class.getName();
  ...
  Size buildResolutionForRatio(int longDimension, @NonNull Rational ratio, boolean isPortrait) {
