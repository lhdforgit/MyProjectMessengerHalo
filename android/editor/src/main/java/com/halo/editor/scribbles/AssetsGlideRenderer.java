 ...
 */
final class AssetsGlideRenderer implements Renderer {
    ...
    AssetsGlideRenderer(@NonNull String path, int maxWidth, int maxHeight) {
        this.path = path;
            ...
            if (rendererContext.isBlockingLoad()) {
                ...
                getBitmapGlideRequest(rendererContext.context, true).into(new CustomTarget<Bitmap>() {
                    ...
                    public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                        ...
                        rendererContext.invalidate.onInvalidate(AssetsGlideRenderer.this);
                    }
    ...
    private void setBitmap(@NonNull RendererContext rendererContext, @Nullable Bitmap bitmap) {
        ...
        if (bitmap != null) {
            ...
            rendererContext.rendererReady.onReady(AssetsGlideRenderer.this, cropMatrix(bitmap), new Point(bitmap.getWidth(), bitmap.getHeight()));
        }
    }
    ...
    public static final Creator<AssetsGlideRenderer> CREATOR = new Creator<AssetsGlideRenderer>() {
        @Override
        public AssetsGlideRenderer createFromParcel(Parcel in) {
            return new AssetsGlideRenderer(in.readString(),
                    in.readInt(),
                    in.readInt()
            );
        }
        ...
        @Override
        public AssetsGlideRenderer[] newArray(int size) {
            return new AssetsGlideRenderer[size];
        }
    };
