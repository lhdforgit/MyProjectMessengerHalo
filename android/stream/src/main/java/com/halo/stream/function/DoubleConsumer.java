...
public interface DoubleConsumer {
    ...
    class Util {
         ...
         * @since 1.1.7
         * @see #safe(com.halo.stream.function.ThrowableDoubleConsumer, com.halo.stream.function.DoubleConsumer)
         */
         ...
         * @throws NullPointerException if {@code throwableConsumer} is null
         * @since 1.1.7
         * @see #safe(com.halo.stream.function.ThrowableDoubleConsumer)
         */
        public static DoubleConsumer safe(
