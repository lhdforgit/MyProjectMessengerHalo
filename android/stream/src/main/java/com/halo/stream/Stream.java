...
import com.halo.stream.function.BinaryOperator;
import com.halo.stream.function.Consumer;
import com.halo.stream.function.Function;
import com.halo.stream.function.IndexedBiFunction;
import com.halo.stream.function.IndexedConsumer;
...
import com.halo.stream.iterator.LazyIterator;
import com.halo.stream.operator.ObjArray;
import com.halo.stream.operator.ObjChunkBy;
import com.halo.stream.operator.ObjConcat;
import com.halo.stream.operator.ObjDistinct;
import com.halo.stream.operator.ObjDistinctBy;
import com.halo.stream.operator.ObjDropWhile;
import com.halo.stream.operator.ObjDropWhileIndexed;
import com.halo.stream.operator.ObjFilter;
import com.halo.stream.operator.ObjFilterIndexed;
import com.halo.stream.operator.ObjFlatMap;
import com.halo.stream.operator.ObjFlatMapToDouble;
import com.halo.stream.operator.ObjFlatMapToInt;
import com.halo.stream.operator.ObjFlatMapToLong;
import com.halo.stream.operator.ObjGenerate;
import com.halo.stream.operator.ObjIterate;
import com.halo.stream.operator.ObjLimit;
import com.halo.stream.operator.ObjMap;
import com.halo.stream.operator.ObjMapIndexed;
import com.halo.stream.operator.ObjMapToDouble;
import com.halo.stream.operator.ObjMapToInt;
import com.halo.stream.operator.ObjMapToLong;
import com.halo.stream.operator.ObjMerge;
import com.halo.stream.operator.ObjPeek;
import com.halo.stream.operator.ObjScan;
import com.halo.stream.operator.ObjScanIdentity;
import com.halo.stream.operator.ObjSkip;
import com.halo.stream.operator.ObjSlidingWindow;
import com.halo.stream.operator.ObjSorted;
import com.halo.stream.operator.ObjTakeUntil;
import com.halo.stream.operator.ObjTakeUntilIndexed;
import com.halo.stream.operator.ObjTakeWhile;
import com.halo.stream.operator.ObjTakeWhileIndexed;
import com.halo.stream.operator.ObjZip;
...
//<editor-fold defaultstate="collapsed" desc="Implementation">
     ...
     * @see #map(com.halo.stream.function.Function)
     */
    @NotNull
     ...
     * @param mapper  the mapper function used to apply to each element
     * @return the new {@code IntStream}
     * @see #flatMap(com.halo.stream.function.Function)
     */
    @NotNull
     ...
     * @param accumulator  the accumulation function
     * @return the result of the reduction
     * @see #reduce(Object, com.halo.stream.function.BiFunction)
     */
    @NotNull
     ...
     * @see #toArray(com.halo.stream.function.IntFunction)
     */
    @NotNull
     ...
     * @param accumulator  the accumulation function
     * @return the result of collect elements
     * @see #collect(com.halo.stream.Collector)
     */
    @Nullable
     ...
     * @return the result of collect elements
     * @see #collect(com.halo.stream.function.Supplier, com.halo.stream.function.BiConsumer)
     */
    @Nullable
