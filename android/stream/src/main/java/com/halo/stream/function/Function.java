...
public interface Function<T, R> {
    ...
    class Util {
         ...
         * @see #andThen(com.halo.stream.function.Function, com.halo.stream.function.Function)
         */
         ...
         * @return the result of composed function
         * @throws NullPointerException if {@code f1} or {@code f2} is null
         * @see #compose(com.halo.stream.function.Function, com.halo.stream.function.Function)
         */
         ...
         * @see #safe(com.halo.stream.function.ThrowableFunction, Object)
         */
         ...
         * @throws NullPointerException if {@code throwableFunction} is null
         * @see #safe(com.halo.stream.function.ThrowableFunction)
         */
        public static <T, R> Function<T, R> safe(
