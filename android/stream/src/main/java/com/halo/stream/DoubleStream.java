...
import com.halo.stream.operator.DoubleArray;
import com.halo.stream.operator.DoubleConcat;
import com.halo.stream.operator.DoubleDropWhile;
import com.halo.stream.operator.DoubleFilter;
import com.halo.stream.operator.DoubleFilterIndexed;
import com.halo.stream.operator.DoubleFlatMap;
import com.halo.stream.operator.DoubleGenerate;
import com.halo.stream.operator.DoubleIterate;
import com.halo.stream.operator.DoubleLimit;
import com.halo.stream.operator.DoubleMap;
import com.halo.stream.operator.DoubleMapIndexed;
import com.halo.stream.operator.DoubleMapToInt;
import com.halo.stream.operator.DoubleMapToLong;
import com.halo.stream.operator.DoubleMapToObj;
import com.halo.stream.operator.DoublePeek;
import com.halo.stream.operator.DoubleSample;
import com.halo.stream.operator.DoubleScan;
import com.halo.stream.operator.DoubleScanIdentity;
import com.halo.stream.operator.DoubleSkip;
import com.halo.stream.operator.DoubleSorted;
import com.halo.stream.operator.DoubleTakeUntil;
import com.halo.stream.operator.DoubleTakeWhile;
...
public final class DoubleStream implements Closeable {
     ...
     * @param accumulator  the accumulation function
     * @return the result of the reduction
     * @see #reduce(com.halo.stream.function.DoubleBinaryOperator)
     */
    @NotNull
