...
public class DatePicker extends FrameLayout {
    ...
    public DatePicker(ViewGroup root, int numberPickerStyle) {
        ...
        // day
        mDaySpinner = (NumberPicker) inflater.inflate(R.layout.date_picker_number_picker_day_month,
        ...
        // month
        mMonthSpinner = (NumberPicker) inflater.inflate(R.layout.date_picker_number_picker_day_month,
                mPickerContainer, false);
        ...
        // year
        mYearSpinner = (NumberPicker) inflater.inflate(R.layout.date_picker_number_picker_year,
                mPickerContainer, false);
    ...
    public DatePicker(Context context, int numberPickerStyle) {
        super(context);
        mContext = context;
    ...
    public void init(int year, int monthOfYear, int dayOfMonth,
                     boolean isDayShown, boolean isMonthShown, boolean isYearShown, OnDateChangedListener onDateChangedListener) {
        mIsDayShown = isDayShown;
