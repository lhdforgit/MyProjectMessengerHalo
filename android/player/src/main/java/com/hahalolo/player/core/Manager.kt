...
import com.hahalolo.player.core.MemoryMode.LOW
import com.hahalolo.player.core.Scope.*
import com.hahalolo.player.core.Strategy.SINGLE_PLAYER
import com.hahalolo.player.logDebug
import com.hahalolo.player.logInfo
import com.hahalolo.player.media.VolumeInfo
import com.hahalolo.player.partitionToMutableSets
import java.util.*
      ...
      .map { /* Bucket --> List<Playback> */
        val candidates = bucketToPlaybacks.getValue(it).filter { playback ->
          val cannotPause = master.manuallyStartedPlayable.get() === playback.playable
                  ...
                  && !requireNotNull(playback.config.controller).playerCanPause()
