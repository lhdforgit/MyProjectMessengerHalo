...
import com.hahalolo.player.BuildConfig
import com.hahalolo.player.core.Bucket.Companion.BOTH_AXIS
import com.hahalolo.player.core.Bucket.Companion.HORIZONTAL
import com.hahalolo.player.core.Bucket.Companion.NONE_AXIS
import com.hahalolo.player.core.Bucket.Companion.VERTICAL
import com.hahalolo.player.core.Common.STATE_ENDED
import com.hahalolo.player.core.Common.STATE_IDLE
import com.hahalolo.player.internal.PlayerParametersChangeListener
import com.hahalolo.player.logDebug
...
inline fun controller(
  playerCanStart: Boolean = true,
  playerCanPause: Boolean = true,
  crossinline setupRenderer: (playback: Playback, renderer: Any?) -> Unit
): Playback.Controller = object : Playback.Controller {
  override fun playerCanStart(): Boolean = playerCanStart
  override fun playerCanPause(): Boolean = playerCanPause
 ...
 *
 * @see [com.hahalolo.player.internal.StaticViewRendererPlayback]
 * @see [com.hahalolo.player.internal.DynamicViewRendererPlayback]
 * @see [com.hahalolo.player.internal.DynamicFragmentRendererPlayback]
 */
abstract class Playback(
  ...
  interface Controller {
     ...
     */
    @JvmDefault
    fun playerCanPause(): Boolean = true
     ...
     */
    @JvmDefault
    fun playerCanStart(): Boolean = false
