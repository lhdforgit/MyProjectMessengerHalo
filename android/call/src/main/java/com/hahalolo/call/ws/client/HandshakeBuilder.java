...
class HandshakeBuilder
{
    ...
    private List<com.hahalolo.call.ws.client.WebSocketExtension> mExtensions;
    ...
    private static boolean isValidProtocol(String protocol)
    {
        ...
        for (int i = 0; i < len; ++i)
        {
            ...
            if (ch < 0x21 || 0x7E < ch || com.hahalolo.call.ws.client.Token.isSeparator(ch))
            {
                return false;
            }
        }
    ...
    public void addExtension(com.hahalolo.call.ws.client.WebSocketExtension extension)
    {
        if (extension == null)
        {
            return;
        ...
        synchronized (this)
        {
            if (mExtensions == null)
            {
                mExtensions = new ArrayList<com.hahalolo.call.ws.client.WebSocketExtension>();
            }
    ...
    {
        addExtension(com.hahalolo.call.ws.client.WebSocketExtension.parse(extension));
    }


    public void removeExtension(com.hahalolo.call.ws.client.WebSocketExtension extension)
    {
        if (extension == null)
        {
            return;
    ...
    public void removeExtensions(String name)
    {
        ...
        synchronized (this)
        {
            ...
            List<com.hahalolo.call.ws.client.WebSocketExtension> extensionsToRemove = new ArrayList<com.hahalolo.call.ws.client.WebSocketExtension>();

            for (com.hahalolo.call.ws.client.WebSocketExtension extension : mExtensions)
            {
            ...
            for (com.hahalolo.call.ws.client.WebSocketExtension extension : extensionsToRemove)
            {
                mExtensions.remove(extension);
            }
    ...
    public boolean containsExtension(com.hahalolo.call.ws.client.WebSocketExtension extension)
    {
        if (extension == null)
        {
            return false;
    ...
    public List<String[]> buildHeaders()
    {
        ...
        {
            headers.add(new String[] { "Authorization", "Basic " + com.hahalolo.call.ws.client.Base64.encode(mUserInfo) } );
        }
    ...
    private static List<com.hahalolo.call.ws.client.WebSocketExtension> copyExtensions(List<com.hahalolo.call.ws.client.WebSocketExtension> extensions)
    {
        if (extensions == null)
        {
            return null;
        ...
        List<com.hahalolo.call.ws.client.WebSocketExtension> newExtensions =
            new ArrayList<com.hahalolo.call.ws.client.WebSocketExtension>(extensions.size());

        for (com.hahalolo.call.ws.client.WebSocketExtension extension : extensions)
        {
            newExtensions.add(new com.hahalolo.call.ws.client.WebSocketExtension(extension));
        }
