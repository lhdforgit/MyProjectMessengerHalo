...
/**
 * Factory to create {@link com.hahalolo.call.ws.client.WebSocket} instances.
 */
public class WebSocketFactory
{
    private final SocketFactorySettings mSocketFactorySettings;
    private final com.hahalolo.call.ws.client.ProxySettings mProxySettings;
    ...
    public WebSocketFactory()
    {
        ...
        mProxySettings         = new com.hahalolo.call.ws.client.ProxySettings(this);
    }
    ...
    public WebSocketFactory(WebSocketFactory other)
    {
        ...
        mProxySettings          = new com.hahalolo.call.ws.client.ProxySettings(this, other.mProxySettings);
     ...
     * @since 1.3
     *
     * @see com.hahalolo.call.ws.client.ProxySettings
     */
    public com.hahalolo.call.ws.client.ProxySettings getProxySettings()
    {
     ...
     * connection. The default value is {@link com.hahalolo.call.ws.client.DualStackMode#BOTH}.
     *
     * <p>
     ...
     *         The dual stack mode.
     */
    public com.hahalolo.call.ws.client.DualStackMode getDualStackMode()
    {
     ...
     *         {@code this} object.
     */
    public WebSocketFactory setDualStackMode(com.hahalolo.call.ws.client.DualStackMode mode)
    {
        mDualStackMode = mode;
     ...
     *         handshake failed.
     */
    public com.hahalolo.call.ws.client.WebSocket createSocket(String uri) throws IOException
    {
     ...
     * @since 1.10
     */
    public com.hahalolo.call.ws.client.WebSocket createSocket(String uri, int timeout) throws IOException
    {
        if (uri == null)
        {
     ...
     *         handshake failed.
     */
    public com.hahalolo.call.ws.client.WebSocket createSocket(URL url) throws IOException
    {
     ...
     * @since 1.10
     */
    public com.hahalolo.call.ws.client.WebSocket createSocket(URL url, int timeout) throws IOException
    {
        if (url == null)
        {
     ...
     */
    public com.hahalolo.call.ws.client.WebSocket createSocket(URI uri) throws IOException
    {
        return createSocket(uri, getConnectionTimeout());
    }
     ...
     * @since 1.10
     */
    public com.hahalolo.call.ws.client.WebSocket createSocket(URI uri, int timeout) throws IOException
    {
        if (uri == null)
        {
            throw new IllegalArgumentException("The given URI is null.");
    ...
    private com.hahalolo.call.ws.client.WebSocket createSocket(
            ...
            String host, int port, boolean secure, int timeout)
    {
        ...
        com.hahalolo.call.ws.client.Address address = new com.hahalolo.call.ws.client.Address(mProxySettings.getHost(), proxyPort);
    ...
    private SocketConnector createDirectRawSocket(String host, int port, boolean secure, int timeout)
    {
        ...
        // The address to connect to.
        com.hahalolo.call.ws.client.Address address = new com.hahalolo.call.ws.client.Address(host, port);
    ...
    private com.hahalolo.call.ws.client.WebSocket createWebSocket(
        ...
        String path, String query, SocketConnector connector)
    {
        ...
        return new com.hahalolo.call.ws.client.WebSocket(this, secure, userInfo, host, path, connector);
    }
}
