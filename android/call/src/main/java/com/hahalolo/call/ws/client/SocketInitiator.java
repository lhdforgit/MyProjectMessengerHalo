...
public class SocketInitiator {
    ...
    private class SocketRacer extends Thread
    {
        ...
        public void run() {
            ...
            try
            {
                ...
                com.hahalolo.call.ws.client.SNIHelper.setServerNames(socket, mServerNames);
    ...
    private class SocketFuture
    {
        ...
        Socket await(List<SocketRacer> racers) throws Exception
        {
            ...
            {
                throw new com.hahalolo.call.ws.client.WebSocketException(com.hahalolo.call.ws.client.WebSocketError.SOCKET_CONNECT_ERROR,
    ...
    private final com.hahalolo.call.ws.client.DualStackMode mMode;
    private final int mFallbackDelay;


    public SocketInitiator(
            SocketFactory socketFactory, com.hahalolo.call.ws.client.Address address, int connectTimeout, String[] serverNames,
            com.hahalolo.call.ws.client.DualStackMode mode, int fallbackDelay)
    {
        mSocketFactory  = socketFactory;
        mAddress        = address;
        mConnectTimeout = connectTimeout;
    ...
    public Socket establish(InetAddress[] addresses) throws Exception
    {
        ...
        for (InetAddress address: addresses)
        {
            ...
            if (mMode == com.hahalolo.call.ws.client.DualStackMode.IPV4_ONLY && !(address instanceof Inet4Address)
                || mMode == com.hahalolo.call.ws.client.DualStackMode.IPV6_ONLY && !(address instanceof Inet6Address))
            {
                continue;
            }
