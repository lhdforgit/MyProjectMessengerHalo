...
import static com.hahalolo.call.ws.client.WebSocketState.CONNECTING;
import static com.hahalolo.call.ws.client.WebSocketState.CREATED;
import static com.hahalolo.call.ws.client.WebSocketState.OPEN;
 ...
 * #addListener(com.hahalolo.call.ws.client.WebSocketListener)} method to register a {@link
 * com.hahalolo.call.ws.client.WebSocketListener} that receives WebSocket events. {@link
 * com.hahalolo.call.ws.client.WebSocketAdapter} is an empty implementation of {@link
 * com.hahalolo.call.ws.client.WebSocketListener} interface.
 * </p>
 *
 * <blockquote>
 * <pre style="border-left: solid 5px lightgray;"> <span style="color: green;">// Register a listener to receive WebSocket events.</span>
 * ws.{@link #addListener(com.hahalolo.call.ws.client.WebSocketListener) addListener}(new {@link
 * com.hahalolo.call.ws.client.WebSocketAdapter#WebSocketAdapter() WebSocketAdapter()} {
 *     <span style="color: gray;">{@code @}Override</span>
 *     public void {@link com.hahalolo.call.ws.client.WebSocketListener#onTextMessage(WebSocket, String)
 ...
 *   <tbody>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#handleCallbackError(WebSocket, Throwable) handleCallbackError}</td>
 *       <td>Called when an <code>on<i>Xxx</i>()</code> method threw a {@code Throwable}.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onBinaryFrame(WebSocket, WebSocketFrame) onBinaryFrame}</td>
 *       <td>Called when a binary frame was received.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onBinaryMessage(WebSocket, byte[]) onBinaryMessage}</td>
 *       <td>Called when a binary message was received.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onCloseFrame(WebSocket, WebSocketFrame) onCloseFrame}</td>
 *       <td>Called when a close frame was received.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onConnected(WebSocket, Map) onConnected}</td>
 *       <td>Called after the opening handshake succeeded.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onConnectError(WebSocket, WebSocketException) onConnectError}</td>
 *       <td>Called when {@link #connectAsynchronously()} failed.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onContinuationFrame(WebSocket, WebSocketFrame) onContinuationFrame}</td>
 *       <td>Called when a continuation frame was received.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onDisconnected(WebSocket, WebSocketFrame, WebSocketFrame, boolean) onDisconnected}</td>
 *       <td>Called after a WebSocket connection was closed.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onError(WebSocket, WebSocketException) onError}</td>
 *       <td>Called when an error occurred.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onFrame(WebSocket, WebSocketFrame) onFrame}</td>
 *       <td>Called when a frame was received.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onFrameError(WebSocket, WebSocketException, WebSocketFrame) onFrameError}</td>
 *       <td>Called when a frame failed to be read.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onFrameSent(WebSocket, WebSocketFrame) onFrameSent}</td>
 *       <td>Called when a frame was sent.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onFrameUnsent(WebSocket, WebSocketFrame) onFrameUnsent}</td>
 *       <td>Called when a frame was not sent.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onMessageDecompressionError(WebSocket, WebSocketException, byte[]) onMessageDecompressionError}</td>
 *       <td>Called when a message failed to be decompressed.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onMessageError(WebSocket, WebSocketException, List) onMessageError}</td>
 *       <td>Called when a message failed to be constructed.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onPingFrame(WebSocket, WebSocketFrame) onPingFrame}</td>
 *       <td>Called when a ping frame was received.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onPongFrame(WebSocket, WebSocketFrame) onPongFrame}</td>
 *       <td>Called when a pong frame was received.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onSendError(WebSocket, WebSocketException, WebSocketFrame) onSendError}</td>
 *       <td>Called when an error occurred on sending a frame.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onSendingFrame(WebSocket, WebSocketFrame) onSendingFrame}</td>
 *       <td>Called before a frame is sent.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onSendingHandshake(WebSocket, String, List) onSendingHandshake}</td>
 *       <td>Called before an opening handshake is sent.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onStateChanged(WebSocket, com.hahalolo.call.ws.client.WebSocketState) onStateChanged}</td>
 *       <td>Called when the state of WebSocket changed.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onTextFrame(WebSocket, WebSocketFrame) onTextFrame}</td>
 *       <td>Called when a text frame was received.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onTextMessage(WebSocket, String) onTextMessage}</td>
 *       <td>Called when a text message was received.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onTextMessageError(WebSocket, WebSocketException, byte[]) onTextMessageError}</td>
 *       <td>Called when a text message failed to be constructed.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onThreadCreated(WebSocket, com.hahalolo.call.ws.client.ThreadType, Thread) onThreadCreated}</td>
 *       <td>Called after a thread was created.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onThreadStarted(WebSocket, com.hahalolo.call.ws.client.ThreadType, Thread) onThreadStarted}</td>
 *       <td>Called at the beginning of a thread's {@code run()} method.
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onThreadStopping(WebSocket, com.hahalolo.call.ws.client.ThreadType, Thread) onThreadStopping}</td>
 *       <td>Called at the end of a thread's {@code run()} method.
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.WebSocketListener#onUnexpectedError(WebSocket, WebSocketException) onUnexpectedError}</td>
 ...
 *     </tr>
 *     <tr>
 *       <td>{@link #addExtension(com.hahalolo.call.ws.client.WebSocketExtension) addExtension}</td>
 ...
 * }
 * catch ({@link com.hahalolo.call.ws.client.HostnameUnverifiedException} e)
 * {
 ...
 *
 * <p>
 * Also, {@code connect()} method throws {@link com.hahalolo.call.ws.client.HostnameUnverifiedException}
 ...
 * com.hahalolo.call.ws.client.WebSocketListener#onConnectError(WebSocket, WebSocketException)
 ...
 * ws.{@link #addExtension(String) addExtension}({@link com.hahalolo.call.ws.client.WebSocketExtension#PERMESSAGE_DEFLATE});</pre>
 * </blockquote>
 *
 ...
 * com.hahalolo.call.ws.client.WebSocketListener#onError(WebSocket, WebSocketException) onError()} method nor
 * {@link com.hahalolo.call.ws.client.WebSocketListener#onFrameError(WebSocket, WebSocketException, WebSocketFrame)
 * onFrameError()} method of {@link com.hahalolo.call.ws.client.WebSocketListener}. If you want to make a
 ...
 *
 * <p>
 * When a text message was received, {@link com.hahalolo.call.ws.client.WebSocketListener#onTextMessage(WebSocket, String)
 ...
 * {@link com.hahalolo.call.ws.client.WebSocketListener#onTextMessage(WebSocket, byte[]) onTextMessage(WebSocket, byte[])}
 ...
 * com.hahalolo.call.ws.client.WebSocketListener#onError(WebSocket, WebSocketException) onError()} method
 * because {@code onError()} may be called multiple times due to one error. Instead,
 * {@link com.hahalolo.call.ws.client.WebSocketListener#onDisconnected(WebSocket, WebSocketFrame, WebSocketFrame,
 ...
 * com.hahalolo.call.ws.client.WebSocketListener#onFrameError(WebSocket, WebSocketException, WebSocketFrame)
 * onFrameError()} and {@link
 * com.hahalolo.call.ws.client.WebSocketListener#onSendError(WebSocket, WebSocketException, WebSocketFrame)
 * onSendError()}. Among such methods, {@link
 * com.hahalolo.call.ws.client.WebSocketListener#onError(WebSocket, WebSocketException) onError()} is a special
 ...
 * com.hahalolo.call.ws.client.WebSocketListener#onUnexpectedError(WebSocket, WebSocketException)
 ...
 * com.hahalolo.call.ws.client.WebSocketListener#onDisconnected(WebSocket, WebSocketFrame, WebSocketFrame, boolean)
 ...
 * are passed to {@link com.hahalolo.call.ws.client.WebSocketListener#handleCallbackError(WebSocket, Throwable)
 * handleCallbackError()} of {@code WebSocketListener}.
 * </p>
 *
 * <blockquote>
 * <pre style="border-left: solid 5px lightgray;"> <span style="color: gray;">{@code @}Override</span>
 * public void {@link com.hahalolo.call.ws.client.WebSocketListener#handleCallbackError(WebSocket, Throwable)
 ...
 *   <tbody>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.ThreadType#READING_THREAD READING_THREAD}</td>
 *       <td>A thread which reads WebSocket frames from the server.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.ThreadType#WRITING_THREAD WRITING_THREAD}</td>
 *       <td>A thread which sends WebSocket frames to the server.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.ThreadType#CONNECT_THREAD CONNECT_THREAD}</td>
 *       <td>A thread which calls {@link WebSocket#connect()} asynchronously.</td>
 *     </tr>
 *     <tr>
 *       <td>{@link com.hahalolo.call.ws.client.ThreadType#FINISH_THREAD FINISH_THREAD}</td>
 ...
 *
 * <p>
 * The following callback methods of {@link com.hahalolo.call.ws.client.WebSocketListener} are called according
 ...
 * implement {@link com.hahalolo.call.ws.client.WebSocketListener#onThreadCreated(WebSocket, com.hahalolo.call.ws.client.ThreadType, Thread)
 * onThreadCreated()} method like below.
 * </p>
 *
 * <blockquote>
 * <pre style="border-left: solid 5px lightgray;"> <span style="color: gray;">{@code @}Override</span>
 * public void {@link com.hahalolo.call.ws.client.WebSocketListener#onThreadCreated(WebSocket, com.hahalolo.call.ws.client.ThreadType, Thread)
 * onThreadCreated}(WebSocket websocket, {@link com.hahalolo.call.ws.client.ThreadType} type, Thread thread)
 * {
...
public class WebSocket
{
    ...
    private final com.hahalolo.call.ws.client.ListenerManager mListenerManager;
    ...
    private List<com.hahalolo.call.ws.client.WebSocketExtension> mAgreedExtensions;
            ...
            String host, String path, SocketConnector connector)
    {
        ...
        mListenerManager   = new com.hahalolo.call.ws.client.ListenerManager(this);
    ...
    public WebSocket recreate(int timeout) throws IOException
    {
        ...
        // Copy listeners.
        List<com.hahalolo.call.ws.client.WebSocketListener> listeners = mListenerManager.getListeners();
     ...
     *
     * <p>
     * The initial state is {@link com.hahalolo.call.ws.client.WebSocketState#CREATED CREATED}.
     * When {@link #connect()} is called, the state is changed to
     * {@link com.hahalolo.call.ws.client.WebSocketState#CONNECTING CONNECTING}, and then to
     * {@link com.hahalolo.call.ws.client.WebSocketState#OPEN OPEN} after a successful opening
     * handshake. The state is changed to {@link
     * com.hahalolo.call.ws.client.WebSocketState#CLOSING CLOSING} when a closing handshake
     * is started, and then to {@link com.hahalolo.call.ws.client.WebSocketState#CLOSED CLOSED}
     * when the closing handshake finished.
     * </p>
     *
     * <p>
     * See the description of {@link com.hahalolo.call.ws.client.WebSocketState} for details.
     * </p>
     *
     * @return
     *         The current state.
     *
     * @see com.hahalolo.call.ws.client.WebSocketState
     */
    public com.hahalolo.call.ws.client.WebSocketState getState()
    {
     ...
     * com.hahalolo.call.ws.client.WebSocketState#OPEN OPEN}.
     *
     * @return
     ...
     */
    private boolean isInState(com.hahalolo.call.ws.client.WebSocketState state)
    {
        synchronized (mStateManager)
        {
     ...
     *         {@code this} object.
     */
    public WebSocket addExtension(com.hahalolo.call.ws.client.WebSocketExtension extension)
    {
     ...
     * @since 1.14
     */
    public WebSocket removeExtension(com.hahalolo.call.ws.client.WebSocketExtension extension)
    {
     ...
     * {@link com.hahalolo.call.ws.client.WebSocketListener#onFrameError(WebSocket,
     ...
     *         {@link com.hahalolo.call.ws.client.WebSocketListener#onError(WebSocket, WebSocketException)
     *         onError()} method and {@link com.hahalolo.call.ws.client.WebSocketListener#onFrameError(WebSocket,
     *         WebSocketException, WebSocketFrame) onFrameError()} method of
     *         {@link com.hahalolo.call.ws.client.WebSocketListener}.
     *
     * @since 1.29
     */
     ...
     * {@link com.hahalolo.call.ws.client.WebSocketListener#onTextMessage(WebSocket, byte[])
     * onTextMessage(WebSocket, byte[])} will be called instead of
     * {@link com.hahalolo.call.ws.client.WebSocketListener#onTextMessage(WebSocket, String)
    ...
    public WebSocket flush()
    {
        synchronized (mStateManager)
        {
            com.hahalolo.call.ws.client.WebSocketState state = mStateManager.getState();
     ...
     *         {@code this} object.
     */
    public WebSocket addListener(com.hahalolo.call.ws.client.WebSocketListener listener)
    {
     ...
     * @since 1.14
     */
    public WebSocket addListeners(List<com.hahalolo.call.ws.client.WebSocketListener> listeners)
    {
     ...
     * @since 1.13
     */
    public WebSocket removeListener(com.hahalolo.call.ws.client.WebSocketListener listener)
    {
     ...
     * @since 1.14
     */
    public WebSocket removeListeners(List<com.hahalolo.call.ws.client.WebSocketListener> listeners)
    {
     ...
     *
     * <p>
     * As necessary, {@link #addProtocol(String)}, {@link #addExtension(com.hahalolo.call.ws.client.WebSocketExtension)}
     ...
     *               com.hahalolo.call.ws.client.WebSocketState#CREATED CREATED}
     ...
     * {@link com.hahalolo.call.ws.client.WebSocketListener#onConnectError(WebSocket, WebSocketException)
     * onConnectError()} method of {@link com.hahalolo.call.ws.client.WebSocketListener} is called.
     *
     * @return
     *         {@code this} object.
     *
    ...
    public WebSocket connectAsynchronously()
    {
        ...
        com.hahalolo.call.ws.client.ListenerManager lm = mListenerManager;

        if (lm != null)
        {
            lm.callOnThreadCreated(com.hahalolo.call.ws.client.ThreadType.CONNECT_THREAD, thread);
        }
     ...
     *         com.hahalolo.call.ws.client.WebSocketListener#onDisconnected(WebSocket, WebSocketFrame,
     ...
     */
    public List<com.hahalolo.call.ws.client.WebSocketExtension> getAgreedExtensions()
    {
     ...
     * com.hahalolo.call.ws.client.WebSocketState#OPEN OPEN}, this method does not accept
     * the frame.
     * </p>
     *
     * <p>
     * Sending a <a href="https://tools.ietf.org/html/rfc6455#section-5.5.1"
     * >close frame</a> changes the state to {@link com.hahalolo.call.ws.client.WebSocketState#CLOSING
     * CLOSING} (if the current state is neither {@link com.hahalolo.call.ws.client.WebSocketState#CLOSING
     * CLOSING} nor {@link com.hahalolo.call.ws.client.WebSocketState#CLOSED CLOSED}).
     * </p>
     *
     * <p>
    ...
    private static String generateWebSocketKey()
    {
        ...
        // "base64-encoded"
        return com.hahalolo.call.ws.client.Base64.encode(data);
    }
    ...
    {
        return new com.hahalolo.call.ws.client.HandshakeReader(this).readHandshake(input, key);
    }
     ...
     */
    com.hahalolo.call.ws.client.ListenerManager getListenerManager()
    {
    ...
    /**
     * Get the handshake builder. {@link com.hahalolo.call.ws.client.HandshakeReader} uses this method.
     */
    ...
    /**
     * Set the agreed extensions. {@link com.hahalolo.call.ws.client.HandshakeReader} uses this method.
     */
    void setAgreedExtensions(List<com.hahalolo.call.ws.client.WebSocketExtension> extensions)
    {
    ...
    /**
     * Set the agreed protocol. {@link com.hahalolo.call.ws.client.HandshakeReader} uses this method.
     */
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onConnected(WebSocket, Map)} method
    ...
    {
        WebSocketThread thread = new com.hahalolo.call.ws.client.FinishThread(this);
    ...
    private PerMessageCompressionExtension findAgreedPerMessageCompressionExtension()
    {
        ...
        for (com.hahalolo.call.ws.client.WebSocketExtension extension : mAgreedExtensions)
        {
