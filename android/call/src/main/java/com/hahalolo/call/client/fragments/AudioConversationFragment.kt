...
import com.hahalolo.call.client.utils.SharedPrefsHelper
import com.hahalolo.call.webrtc.AppRTCAudioManager
import javax.inject.Inject

const val SPEAKER_ENABLED = "is_speaker_enabled"

class AudioConversationFragment
@Inject constructor() : BaseConversationFragment(), CallActivity.OnChangeAudioDevice {
    ...
    override fun configureActionBar() {
        actionBar.subtitle =
            String.format(getString(R.string.subtitle_text_logged_in_as), controller.oauthInfoName)
    }
    ...
    override fun initViews(view: View?) {
        ...
        audioSwitchToggleButton.isChecked = SharedPrefsHelper.get(SPEAKER_ENABLED, true, controller.sharedPreferences)
    ...
    override fun initButtonsListener() {
        ...
        audioSwitchToggleButton.setOnCheckedChangeListener { buttonView, isChecked ->
            SharedPrefsHelper.save(SPEAKER_ENABLED, isChecked, controller.sharedPreferences)
