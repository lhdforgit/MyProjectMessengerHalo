...
import static com.hahalolo.call.ws.client.WebSocketOpcode.BINARY;
import static com.hahalolo.call.ws.client.WebSocketOpcode.CLOSE;
import static com.hahalolo.call.ws.client.WebSocketOpcode.CONTINUATION;
import static com.hahalolo.call.ws.client.WebSocketOpcode.PING;
import static com.hahalolo.call.ws.client.WebSocketOpcode.PONG;
import static com.hahalolo.call.ws.client.WebSocketOpcode.TEXT;
...
class ReadingThread extends com.hahalolo.call.ws.client.WebSocketThread
{
    private boolean mStopRequested;
    private com.hahalolo.call.ws.client.WebSocketFrame mCloseFrame;
    private List<com.hahalolo.call.ws.client.WebSocketFrame> mContinuation = new ArrayList<com.hahalolo.call.ws.client.WebSocketFrame>();
    ...
    public ReadingThread(com.hahalolo.call.ws.client.WebSocket websocket)
    {
        super("ReadingThread", websocket, com.hahalolo.call.ws.client.ThreadType.READING_THREAD);
    ...
    private void main()
    {
        ...
        while (true)
        {
            ...
            com.hahalolo.call.ws.client.WebSocketFrame frame = readFrame();
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onFrame(com.hahalolo.call.ws.client.WebSocket, com.hahalolo.call.ws.client.WebSocketFrame) onFrame}
     * method of the listeners.
     */
    private void callOnFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onContinuationFrame(com.hahalolo.call.ws.client.WebSocket, com.hahalolo.call.ws.client.WebSocketFrame)
     * onContinuationFrame} method of the listeners.
     */
    private void callOnContinuationFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onTextFrame(com.hahalolo.call.ws.client.WebSocket, com.hahalolo.call.ws.client.WebSocketFrame)
     * onTextFrame} method of the listeners.
     */
    private void callOnTextFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onBinaryFrame(com.hahalolo.call.ws.client.WebSocket, com.hahalolo.call.ws.client.WebSocketFrame)
     * onBinaryFrame} method of the listeners.
     */
    private void callOnBinaryFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onCloseFrame(com.hahalolo.call.ws.client.WebSocket, com.hahalolo.call.ws.client.WebSocketFrame)
     * onCloseFrame} method of the listeners.
     */
    private void callOnCloseFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onPingFrame(com.hahalolo.call.ws.client.WebSocket, com.hahalolo.call.ws.client.WebSocketFrame)
     * onPingFrame} method of the listeners.
     */
    private void callOnPingFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onPongFrame(com.hahalolo.call.ws.client.WebSocket, com.hahalolo.call.ws.client.WebSocketFrame)
     * onPongFrame} method of the listeners.
     */
    private void callOnPongFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onTextMessage(com.hahalolo.call.ws.client.WebSocket, String)
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onBinaryMessage(com.hahalolo.call.ws.client.WebSocket, String)
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onError(com.hahalolo.call.ws.client.WebSocket, WebSocketException)
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onFrameError(com.hahalolo.call.ws.client.WebSocket,
     * WebSocketException, com.hahalolo.call.ws.client.WebSocketFrame) onFrameError} method of the listeners.
     */
    private void callOnFrameError(WebSocketException cause, com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onMessageError(com.hahalolo.call.ws.client.WebSocket, WebSocketException, List)
     * onMessageError} method of the listeners.
     */
    private void callOnMessageError(WebSocketException cause, List<com.hahalolo.call.ws.client.WebSocketFrame> frames)
    {
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onMessageDecompressionError(com.hahalolo.call.ws.client.WebSocket, WebSocketException, byte[])
    ...
    /**
     * Call {@link com.hahalolo.call.ws.client.WebSocketListener#onTextMessageError(com.hahalolo.call.ws.client.WebSocket, WebSocketException, byte[])
    ...
    private com.hahalolo.call.ws.client.WebSocketFrame readFrame()
    {
        com.hahalolo.call.ws.client.WebSocketFrame frame = null;
        ...
        if (wse instanceof com.hahalolo.call.ws.client.NoMoreFrameException)
        {
        ...
        com.hahalolo.call.ws.client.WebSocketFrame closeFrame = createCloseFrame(wse);
    ...
    private void verifyFrame(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
    ...
    private void verifyReservedBits(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
     ...
     */
    private void verifyReservedBit1(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
     ...
     */
    private boolean verifyReservedBit1ForPMCE(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
     ...
     */
    private void verifyReservedBit2(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
     ...
     */
    private void verifyReservedBit3(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
     ...
     * </blockquote>
     */
    private void verifyFrameOpcode(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
     ...
     * </blockquote>
     */
    private void verifyFrameMask(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
    ...
    private void verifyFrameFragmentation(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
    ...
    private void verifyFrameSize(com.hahalolo.call.ws.client.WebSocketFrame frame) throws WebSocketException
    {
    ...
    private com.hahalolo.call.ws.client.WebSocketFrame createCloseFrame(WebSocketException wse)
    {
        int closeCode;
        ...
        return com.hahalolo.call.ws.client.WebSocketFrame.createCloseFrame(closeCode, wse.getMessage());
    }


    private boolean handleFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    private boolean handleContinuationFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    private byte[] getMessage(List<com.hahalolo.call.ws.client.WebSocketFrame> frames)
    {
    ...
    private byte[] concatenatePayloads(List<com.hahalolo.call.ws.client.WebSocketFrame> frames)
    {
        Throwable cause;
        ...
        try
        {
            ...
            for (com.hahalolo.call.ws.client.WebSocketFrame frame : frames)
            {
        ...
        com.hahalolo.call.ws.client.WebSocketFrame frame = com.hahalolo.call.ws.client.WebSocketFrame
    ...
    private byte[] getMessage(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    private boolean handleTextFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    private boolean handleBinaryFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    private boolean handleCloseFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
    ...
    private boolean handlePingFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
        ...
        // the ping frame.
        com.hahalolo.call.ws.client.WebSocketFrame pong = com.hahalolo.call.ws.client.WebSocketFrame
    ...
    private boolean handlePongFrame(com.hahalolo.call.ws.client.WebSocketFrame frame)
    {
