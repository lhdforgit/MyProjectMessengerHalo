...
class PongSender extends PeriodicalFrameSender
{
    ...
    public PongSender(com.hahalolo.call.ws.client.WebSocket webSocket, com.hahalolo.call.ws.client.PayloadGenerator generator)
    {
    ...
    {
        return com.hahalolo.call.ws.client.WebSocketFrame.createPongFrame(payload);
    }
}
