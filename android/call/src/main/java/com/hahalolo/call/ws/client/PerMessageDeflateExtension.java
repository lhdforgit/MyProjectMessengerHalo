 ...
 */
class PerMessageDeflateExtension extends com.hahalolo.call.ws.client.PerMessageCompressionExtension
{
    ...
    {
        super(com.hahalolo.call.ws.client.WebSocketExtension.PERMESSAGE_DEFLATE);
    }
    ...
    @Override
    void validate() throws com.hahalolo.call.ws.client.WebSocketException
    {
        // For each parameter
    ...
    private void validateParameter(String key, String value) throws com.hahalolo.call.ws.client.WebSocketException
    {
        ...
        else
        {
            ...
            throw new com.hahalolo.call.ws.client.WebSocketException(
    ...
    private int computeWindowSize(String key, String value) throws com.hahalolo.call.ws.client.WebSocketException
    {
    ...
    private int extractMaxWindowBits(String key, String value) throws com.hahalolo.call.ws.client.WebSocketException
    {
    ...
    @Override
    protected byte[] decompress(byte[] compressed) throws com.hahalolo.call.ws.client.WebSocketException
    {
        ...
        {
            // Decompress.
            com.hahalolo.call.ws.client.DeflateDecompressor.decompress(input, mIncomingSlidingWindow);
        }
        catch (Exception e)
        {
    ...
    @Override
    protected byte[] compress(byte[] plain) throws com.hahalolo.call.ws.client.WebSocketException
    {
    ...
    private static byte[] adjustCompressedData(byte[] compressed) throws com.hahalolo.call.ws.client.FormatException
    {
    ...
    private static boolean skipBlock(
            ByteArray input, int[] bitIndex, boolean[] hasEmptyBlock) throws com.hahalolo.call.ws.client.FormatException
    {
        ...
        switch (type)
        {
            ...
            default:
                ...
                throw new com.hahalolo.call.ws.client.FormatException(message);
        }
    ...
    private static void skipFixedBlock(ByteArray input, int[] bitIndex) throws com.hahalolo.call.ws.client.FormatException
    {
        ...
        skipData(input, bitIndex,
                ...
                com.hahalolo.call.ws.client.FixedDistanceHuffman.getInstance());
    }


    private static void skipDynamicBlock(ByteArray input, int[] bitIndex) throws com.hahalolo.call.ws.client.FormatException
    {
        ...
        com.hahalolo.call.ws.client.Huffman[] tables = new com.hahalolo.call.ws.client.Huffman[2];
    ...
    private static void skipData(
            ...
            com.hahalolo.call.ws.client.Huffman literalLengthHuffman, com.hahalolo.call.ws.client.Huffman distanceHuffman) throws com.hahalolo.call.ws.client.FormatException
    {
