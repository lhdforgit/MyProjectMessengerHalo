 ...
 * @since 1.19
 */
public class OpeningHandshakeException extends com.hahalolo.call.ws.client.WebSocketException
{
    private static final long serialVersionUID = 1L;


    private final com.hahalolo.call.ws.client.StatusLine mStatusLine;
    ...
    OpeningHandshakeException(
            ...
            com.hahalolo.call.ws.client.StatusLine statusLine, Map<String, List<String>> headers)
    {
    ...
    OpeningHandshakeException(
            WebSocketError error, String message,
            com.hahalolo.call.ws.client.StatusLine statusLine, Map<String, List<String>> headers, byte[] body)
    {
        super(error, message);
     ...
     *         The status line.
     */
    public com.hahalolo.call.ws.client.StatusLine getStatusLine()
    {
        return mStatusLine;
    }
