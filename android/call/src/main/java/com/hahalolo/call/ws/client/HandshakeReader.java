...
class HandshakeReader
{
    ...
    private void validateExtensions(StatusLine statusLine, Map<String, List<String>> headers) throws WebSocketException
    {
        ...
        List<com.hahalolo.call.ws.client.WebSocketExtension> extensions = new ArrayList<com.hahalolo.call.ws.client.WebSocketExtension>();
        ...
        for (String value : values)
        {
            ...
            for (String element : elements)
            {
                ...
                com.hahalolo.call.ws.client.WebSocketExtension extension = com.hahalolo.call.ws.client.WebSocketExtension.parse(element);
    ...
    private void validateExtensionCombination(
            StatusLine statusLine, Map<String, List<String>> headers, List<com.hahalolo.call.ws.client.WebSocketExtension> extensions) throws WebSocketException
    {
        ...
        com.hahalolo.call.ws.client.WebSocketExtension pmce = null;
