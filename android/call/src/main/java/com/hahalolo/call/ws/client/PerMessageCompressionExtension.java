 ...
 */
abstract class PerMessageCompressionExtension extends com.hahalolo.call.ws.client.WebSocketExtension
{
    ...
    public PerMessageCompressionExtension(com.hahalolo.call.ws.client.WebSocketExtension source)
    {
        super(source);
    }
