...
public class WebSocketFrame
{
     ...
     *         The opcode.
     *
     * @see com.hahalolo.call.ws.client.WebSocketOpcode
     */
     ...
     * opcode is 0x0 ({@link com.hahalolo.call.ws.client.WebSocketOpcode#CONTINUATION}).
     * </p>
     *
     * @return
     ...
     * <p>
     * This method returns {@code true} when the value of the
     * opcode is 0x1 ({@link com.hahalolo.call.ws.client.WebSocketOpcode#TEXT}).
     * </p>
     *
     * @return
     ...
     * <p>
     * This method returns {@code true} when the value of the
     * opcode is 0x2 ({@link com.hahalolo.call.ws.client.WebSocketOpcode#BINARY}).
     * </p>
     *
     * @return
     ...
     * <p>
     * This method returns {@code true} when the value of the
     * opcode is 0x8 ({@link com.hahalolo.call.ws.client.WebSocketOpcode#CLOSE}).
     * </p>
     *
     * @return
     ...
     * <p>
     * This method returns {@code true} when the value of the
     * opcode is 0x9 ({@link com.hahalolo.call.ws.client.WebSocketOpcode#PING}).
     * </p>
     *
     * @return
     ...
     * <p>
     * This method returns {@code true} when the value of the
     * opcode is 0xA ({@link com.hahalolo.call.ws.client.WebSocketOpcode#PONG}).
     * </p>
     *
     * @return
     ...
     *         {@link com.hahalolo.call.ws.client.WebSocketOpcode#CONTINUATION CONTINUATION} and
     ...
     *         {@link com.hahalolo.call.ws.client.WebSocketOpcode#TEXT TEXT} and payload is
     *         the given one.
     */
     ...
     * @return
     *         A WebSocket frame whose FIN bit is true, opcode is
     *         {@link com.hahalolo.call.ws.client.WebSocketOpcode#BINARY BINARY} and payload is
     *         the given one.
     */
     ...
     * @return
     *         A WebSocket frame whose FIN bit is true, opcode is
     *         {@link com.hahalolo.call.ws.client.WebSocketOpcode#CLOSE CLOSE} and payload is
     *         {@code null}.
     */
     ...
     * @return
     *         A WebSocket frame whose FIN bit is true, opcode is
     *         {@link com.hahalolo.call.ws.client.WebSocketOpcode#CLOSE CLOSE} and payload
     ...
     * @return
     *         A WebSocket frame whose FIN bit is true, opcode is
     *         {@link com.hahalolo.call.ws.client.WebSocketOpcode#PING PING} and payload is
     *         {@code null}.
     */
     ...
     * @return
     *         A WebSocket frame whose FIN bit is true, opcode is
     *         {@link com.hahalolo.call.ws.client.WebSocketOpcode#PONG PONG} and payload is
     *         {@code null}.
     */
