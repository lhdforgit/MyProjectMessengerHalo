...
public interface WebSocketListener
{
     ...
     * @since 2.0
     */
    void onThreadCreated(WebSocket websocket, com.hahalolo.call.ws.client.ThreadType threadType, Thread thread) throws Exception;
     ...
     * @since 2.0
     */
    void onThreadStarted(WebSocket websocket, com.hahalolo.call.ws.client.ThreadType threadType, Thread thread) throws Exception;
     ...
     * @since 2.0
     */
    void onThreadStopping(WebSocket websocket, com.hahalolo.call.ws.client.ThreadType threadType, Thread thread) throws Exception;
