...
abstract class PeriodicalFrameSender
{
    ...
    private com.hahalolo.call.ws.client.PayloadGenerator mGenerator;


    public PeriodicalFrameSender(
            com.hahalolo.call.ws.client.WebSocket webSocket, String timerName, com.hahalolo.call.ws.client.PayloadGenerator generator)
    {
    ...
    public com.hahalolo.call.ws.client.PayloadGenerator getPayloadGenerator()
    {
        synchronized (this)
        {
            return mGenerator;
    ...
    public void setPayloadGenerator(com.hahalolo.call.ws.client.PayloadGenerator generator)
    {
        synchronized (this)
        {
            mGenerator = generator;
    ...
    private com.hahalolo.call.ws.client.WebSocketFrame createFrame()
    {
    ...
    protected abstract com.hahalolo.call.ws.client.WebSocketFrame createFrame(byte[] payload);
}
