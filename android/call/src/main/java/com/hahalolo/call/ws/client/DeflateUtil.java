...
class DeflateUtil
{
    ...
    public static void readDynamicTables(
            com.hahalolo.call.ws.client.ByteArray input, int[] bitIndex, com.hahalolo.call.ws.client.Huffman[] tables) throws com.hahalolo.call.ws.client.FormatException
    {
        ...
        // "code length value".
        com.hahalolo.call.ws.client.Huffman codeLengthHuffman = new com.hahalolo.call.ws.client.Huffman(codeLengthsFromCodeLengthValue);
        ...
        com.hahalolo.call.ws.client.Huffman literalLengthHuffman = new com.hahalolo.call.ws.client.Huffman(codeLengthsFromLiteralLengthCode);
        ...
        // "distance symbol".
        com.hahalolo.call.ws.client.Huffman distanceHuffman = new com.hahalolo.call.ws.client.Huffman(codeLengthsFromDistanceCode);
    ...
    private static void readCodeLengths(
            com.hahalolo.call.ws.client.ByteArray input, int bitIndex[], int[] codeLengths,
            com.hahalolo.call.ws.client.Huffman codeLengthHuffman) throws com.hahalolo.call.ws.client.FormatException
    {
        // 3.2.7 Compression with dynamic Huffman codes (BTYPE=10)
    ...
    public static int readLength(
            com.hahalolo.call.ws.client.ByteArray input, int[] bitIndex, int literalLength) throws com.hahalolo.call.ws.client.FormatException
    {
    ...
    public static int readDistance(
            com.hahalolo.call.ws.client.ByteArray input, int[] bitIndex, com.hahalolo.call.ws.client.Huffman distanceHuffman) throws com.hahalolo.call.ws.client.FormatException
    {
        // 3.2.5 Compressed blocks (length and distance code)
