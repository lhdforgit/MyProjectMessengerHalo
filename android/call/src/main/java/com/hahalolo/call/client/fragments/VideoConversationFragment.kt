...
import com.hahalolo.call.client.utils.shortToast
...
import com.hahalolo.call.webrtc.view.QBRTCSurfaceView
...
@Inject constructor() : BaseConversationFragment(), Serializable,
     ...
     */
    private fun fillVideoView(videoView: QBRTCSurfaceView,
     ...
     * @param userId set userId if it from fullscreen videoTrack
     */
    private fun fillVideoView(userId: Int, videoView: QBRTCSurfaceView) {
        if (userId != 0) {
            userIDFullScreen = userId
        }
        fillVideoView(videoView, true)
    }
