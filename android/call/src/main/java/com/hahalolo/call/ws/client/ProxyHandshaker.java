...
class ProxyHandshaker
{
    ...
    private final com.hahalolo.call.ws.client.ProxySettings mSettings;


    public ProxyHandshaker(String host, int port, com.hahalolo.call.ws.client.ProxySettings settings)
    {
        mHost     = host;
        mPort     = port;
        mSettings = settings;
    ...
    private void addProxyAuthorization(StringBuilder builder)
    {
        ...
        builder
            ...
            .append(com.hahalolo.call.ws.client.Base64.encode(credentials))
            .append(RN);
    }
