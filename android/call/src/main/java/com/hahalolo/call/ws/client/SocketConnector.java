...
class SocketConnector
{
    ...
    private final com.hahalolo.call.ws.client.Address mAddress;
    private final int mConnectionTimeout;
    private final int mSocketTimeout;
    private final String[] mServerNames;
    private final com.hahalolo.call.ws.client.ProxyHandshaker mProxyHandshaker;
    private final SSLSocketFactory mSSLSocketFactory;
    private final String mHost;
    private final int mPort;
    private com.hahalolo.call.ws.client.DualStackMode mDualStackMode = com.hahalolo.call.ws.client.DualStackMode.BOTH;
    private int mDualStackFallbackDelay = 250;
    private boolean mVerifyHostname;
    private Socket mSocket;

    SocketConnector(SocketFactory socketFactory, com.hahalolo.call.ws.client.Address address, int timeout, String[] serverNames, int socketTimeout)
    {
    ...
    SocketConnector(
            SocketFactory socketFactory, com.hahalolo.call.ws.client.Address address, int timeout, int socketTimeout, String[] serverNames,
            com.hahalolo.call.ws.client.ProxyHandshaker handshaker, SSLSocketFactory sslSocketFactory,
    ...
    public Socket getConnectedSocket() throws com.hahalolo.call.ws.client.WebSocketException
    {
        // Connect lazily.
        if (mSocket == null)
        {
    ...
    private void connectSocket() throws com.hahalolo.call.ws.client.WebSocketException
    {
        // Create socket initiator.
        com.hahalolo.call.ws.client.SocketInitiator socketInitiator = new com.hahalolo.call.ws.client.SocketInitiator(
        ...
        catch (Exception e)
        {
            ...
            throw new com.hahalolo.call.ws.client.WebSocketException(com.hahalolo.call.ws.client.WebSocketError.SOCKET_CONNECT_ERROR, message, e);
        }
    }


    private InetAddress[] resolveHostname() throws com.hahalolo.call.ws.client.WebSocketException
    {
        ...
        // Raise an exception with SOCKET_CONNECT_ERROR.
        throw new com.hahalolo.call.ws.client.WebSocketException(com.hahalolo.call.ws.client.WebSocketError.SOCKET_CONNECT_ERROR, message, exception);
    }


    public Socket connect() throws com.hahalolo.call.ws.client.WebSocketException
    {
        try
        {
    ...
    SocketConnector setDualStackSettings(com.hahalolo.call.ws.client.DualStackMode mode, int fallbackDelay)
    {
        mDualStackMode          = mode;
    ...
    private void doConnect() throws com.hahalolo.call.ws.client.WebSocketException
    {
        // True if a proxy server is set.
        boolean proxied = mProxyHandshaker != null;
    ...
    private void setSoTimeout(int timeout) throws com.hahalolo.call.ws.client.WebSocketException
    {
    ...
    private void verifyHostname(SSLSocket socket, String hostname) throws com.hahalolo.call.ws.client.HostnameUnverifiedException
    {
        ...
        // Hostname verifier.
        com.hahalolo.call.ws.client.OkHostnameVerifier verifier = com.hahalolo.call.ws.client.OkHostnameVerifier.INSTANCE;
        ...
        throw new com.hahalolo.call.ws.client.HostnameUnverifiedException(socket, hostname);
    }
     ...
     */
    private void handshake() throws com.hahalolo.call.ws.client.WebSocketException
    {
        // Sanity check
        assert mSocket != null;
        ...
        catch (IOException e)
        {
            ...
            throw new com.hahalolo.call.ws.client.WebSocketException(com.hahalolo.call.ws.client.WebSocketError.PROXY_HANDSHAKE_ERROR, message, e);
        }
        ...
        catch (IOException e)
        {
            ...
            throw new com.hahalolo.call.ws.client.WebSocketException(com.hahalolo.call.ws.client.WebSocketError.SOCKET_OVERLAY_ERROR, message, e);
        }
        ...
        catch (IOException e)
        {
            ...
            throw new com.hahalolo.call.ws.client.WebSocketException(com.hahalolo.call.ws.client.WebSocketError.SSL_HANDSHAKE_ERROR, message, e);
        }
    }
