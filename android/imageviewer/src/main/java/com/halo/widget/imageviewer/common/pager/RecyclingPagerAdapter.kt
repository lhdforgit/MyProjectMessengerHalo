...
package com.halo.widget.imageviewer.common.pager
...
import com.halo.widget.imageviewer.common.extensions.forEach
...
internal abstract class RecyclingPagerAdapter<VH : RecyclingPagerAdapter.ViewHolder>
    ...
    override fun restoreState(state: Parcelable?, loader: ClassLoader?) {
        if (state != null && state is Bundle) {
            ...
            savedStates = (if (state.containsKey(STATE)) state.getSparseParcelableArray(STATE) else SparseArray()) ?: SparseArray()
        }
