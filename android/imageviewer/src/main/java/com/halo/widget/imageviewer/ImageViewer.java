...
package com.halo.widget.imageviewer;
...
import com.halo.widget.imageviewer.viewer.dialog.ImageViewerDialog;
...
public class ImageViewer<T> {
    ...
    public static class Builder<T> {
        ...
        public Builder<T> withDownloadListener(OnDownloadImageListener onDownloadImageListener) {
            this.data.setOnDownloadImageListener(onDownloadImageListener);
            return this;
        }
